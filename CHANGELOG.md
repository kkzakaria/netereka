...
## [1.1.0](https://github.com/kkzakaria/netereka/compare/v1.0.0...v1.1.0) (2026-04-15)


### Features

* add AI-assisted content generation in admin ([#70](https://github.com/kkzakaria/netereka/issues/70)) ([ebf3304](https://github.com/kkzakaria/netereka/commit/ebf3304032815a60010790628f2c8b973fcb6398))
* add auth guards and server actions tests (74 tests) ([#53](https://github.com/kkzakaria/netereka/issues/53)) ([6fe178c](https://github.com/kkzakaria/netereka/commit/6fe178c9f69bb6be7352ddefdd96393162cc15ef))
* add cart store and checkout calculation tests ([#51](https://github.com/kkzakaria/netereka/issues/51)) ([53f1873](https://github.com/kkzakaria/netereka/commit/53f1873ba48dcf86578067eb474f47c9442cfd69))
* add Cloudflare Image Transformations binding for AVIF support ([#57](https://github.com/kkzakaria/netereka/issues/57)) ([e5e96e0](https://github.com/kkzakaria/netereka/commit/e5e96e047305a8a77306a26d5b9ac2b02d7eb0dc))
* add expandable rows to admin categories table ([#65](https://github.com/kkzakaria/netereka/issues/65)) ([d87ef70](https://github.com/kkzakaria/netereka/commit/d87ef70395844a25d9224d5583fd758c8381ba9c))
* add tests for email templates, search builder & constants ([#52](https://github.com/kkzakaria/netereka/issues/52)) ([4c64ea9](https://github.com/kkzakaria/netereka/commit/4c64ea9744eeb6afa186aa3bffb1ca69d6a72c89))
* add Vitest test framework with 121 unit tests ([#50](https://github.com/kkzakaria/netereka/issues/50)) ([ae8fd5e](https://github.com/kkzakaria/netereka/commit/ae8fd5ea0e836c569e58897efcff6ff5d1e0e883))
...
* **admin:** allow image upload during banner creation ([#92](https://github.com/kkzakaria/netereka/issues/92)) ([a292d7f](https://github.com/kkzakaria/netereka/commit/a292d7fea3b4d91ade033d6cb38e04a510f0a10c))
...
* **admin:** banner live preview, gradient presets and saved gradients ([#89](https://github.com/kkzakaria/netereka/issues/89)) ([4b02360](https://github.com/kkzakaria/netereka/commit/4b0236034d170862b93b93650b8b4dee617f98cf))
...
* **ai:** add Zod validation schemas for AI responses ([#69](https://github.com/kkzakaria/netereka/issues/69)) ([84d162a](https://github.com/kkzakaria/netereka/commit/84d162a240fc275eb463b5674e5d90a8519e7d08))
* **ai:** AI-powered full product creation from name+brand ([#73](https://github.com/kkzakaria/netereka/issues/73)) ([54b6b25](https://github.com/kkzakaria/netereka/commit/54b6b25813f0160d30cc146ff0f4ecaf94a4fd11))
* **ai:** enrich product text generation with Brave Search specs ([#72](https://github.com/kkzakaria/netereka/issues/72)) ([f657445](https://github.com/kkzakaria/netereka/commit/f657445024499e9722f62e3a2bc7992337657de0))
* **ai:** rebuild product creation with SSE streaming and editable preview ([#81](https://github.com/kkzakaria/netereka/issues/81)) ([7103335](https://github.com/kkzakaria/netereka/commit/71033354abdc83898cb136328f252f418a39646a))
* **ai:** replace Workers AI text model with OpenRouter Qwen3.5 397B A17B ([#74](https://github.com/kkzakaria/netereka/issues/74)) ([316b3c4](https://github.com/kkzakaria/netereka/commit/316b3c49211daaa10b802c03d8ab5783f3835fb6))
...
* automate D1 migrations in deploy pipeline ([#67](https://github.com/kkzakaria/netereka/issues/67)) ([01f1d11](https://github.com/kkzakaria/netereka/commit/01f1d1185db30be5ccf11917e2cc576044ec7070))
...
* guided sectioned product form with cascading categories ([#66](https://github.com/kkzakaria/netereka/issues/66)) ([52ce998](https://github.com/kkzakaria/netereka/commit/52ce998b65079819f930959ebec89c20556274a1))
* hero carousel with banner management system ([#60](https://github.com/kkzakaria/netereka/issues/60)) ([36c74b3](https://github.com/kkzakaria/netereka/commit/36c74b363b78cca426b88452e73ddb772380818f))
* **hero:** increase image size on desktop ([#82](https://github.com/kkzakaria/netereka/issues/82)) ([bdf5603](https://github.com/kkzakaria/netereka/commit/bdf560337e84181e3af0c6515e3e335169d3f81b))
...
* implement hierarchical subcategories ([#64](https://github.com/kkzakaria/netereka/issues/64)) ([290f759](https://github.com/kkzakaria/netereka/commit/290f7596e52d21e1522297cae398fc2e7757a728))
...
* unify Drizzle schema and migration pipeline ([#68](https://github.com/kkzakaria/netereka/issues/68)) ([3d47399](https://github.com/kkzakaria/netereka/commit/3d4739991c7856fb4120cd55ff90c5b68cbe42ea))
...
* address Web Interface Guidelines audit findings ([5056760](https://github.com/kkzakaria/netereka/commit/505676031c4df5c8f5155df3520645a63a1eb5be))
...
* **admin:** move banner preview to full-width sticky top, proportional sizing ([#91](https://github.com/kkzakaria/netereka/issues/91)) ([c554424](https://github.com/kkzakaria/netereka/commit/c554424314fc7d81fd0398d0c1aeee6bef551a48))
...
* **admin:** remove AI generation and add inline color picker ([#90](https://github.com/kkzakaria/netereka/issues/90)) ([b3b6eb0](https://github.com/kkzakaria/netereka/commit/b3b6eb0c2105308efc2b55b2012dfbb92119837f))
...
* **banners:** store R2 key directly to fix image display in production ([#77](https://github.com/kkzakaria/netereka/issues/77)) ([3f4402e](https://github.com/kkzakaria/netereka/commit/3f4402e4f567a815a9ed75a3f5d042a1b2b854b8))
* captcha validation and reset on auth pages ([#61](https://github.com/kkzakaria/netereka/issues/61)) ([8fb4547](https://github.com/kkzakaria/netereka/commit/8fb45474b4c9a38bfdc33e03600829ab265ebc69))
...
* check both session cookie names in middleware ([84d58a0](https://github.com/kkzakaria/netereka/commit/84d58a0c50f7d80e610e7d192139cb46f80523da))
...
* **ci:** pass Cloudflare credentials to build worker step ([#71](https://github.com/kkzakaria/netereka/issues/71)) ([25ec2bd](https://github.com/kkzakaria/netereka/commit/25ec2bdd24c027b50027892d52816746c3574910))
* **ci:** remove per-variant price field to fix TypeScript errors ([#80](https://github.com/kkzakaria/netereka/issues/80)) ([1e2210b](https://github.com/kkzakaria/netereka/commit/1e2210b13ee7a89da7a8d2e40009ea8c02d7510f))
* **ci:** remove synchronous setState in useEffect (react-hooks/set-state-in-effect) ([#78](https://github.com/kkzakaria/netereka/issues/78)) ([9b228ee](https://github.com/kkzakaria/netereka/commit/9b228eefaeaf4606279ea94866dc74a2e56666c5))
* correct rel=canonical on product pages ([5855e15](https://github.com/kkzakaria/netereka/commit/5855e1524a82f126a2cf23faff2a7057c75926a5))
* correct robots.txt and optimize mobile LCP ([#55](https://github.com/kkzakaria/netereka/issues/55)) ([05e83b3](https://github.com/kkzakaria/netereka/commit/05e83b3b4b8e564034f3e2948cd21ca5a5dc7377))
...
* **dev:** use wrangler.dev.jsonc to exclude AI binding in local dev ([dcfa272](https://github.com/kkzakaria/netereka/commit/dcfa2727b00910e684c90ca41594898ef3457ce7))
...
* **hero:** fill hero height with product image instead of capped square ([#86](https://github.com/kkzakaria/netereka/issues/86)) ([6d35889](https://github.com/kkzakaria/netereka/commit/6d358896ebbf4da247ae1561849c3ed76659b67b))
* **hero:** show product image on mobile via always-on 2-column layout ([#87](https://github.com/kkzakaria/netereka/issues/87)) ([e479a75](https://github.com/kkzakaria/netereka/commit/e479a7588bfcb7cbffb7d109d161398d03569c30))
...
* **kysely-d1:** remove deprecated numUpdatedOrDeletedRows from QueryResult ([#85](https://github.com/kkzakaria/netereka/issues/85)) ([77ef816](https://github.com/kkzakaria/netereka/commit/77ef816f142998a00e438b15c3ab0d578fbb42bf))
...
* make homepage force-dynamic to prevent build-time prerendering ([cef0583](https://github.com/kkzakaria/netereka/commit/cef0583990b6a75a917541e89a530ab332038fda))
* make migration 0010 safe against cascade deletes ([fc67015](https://github.com/kkzakaria/netereka/commit/fc67015054730735b21ec4d3ed4900800470786f))
* **opennext:** suppress env.IMAGES binding warnings in production logs ([#84](https://github.com/kkzakaria/netereka/issues/84)) ([ed07a77](https://github.com/kkzakaria/netereka/commit/ed07a776c3612c28d79b3e17e50392462caec223))
* pass NEXT_PUBLIC_R2_URL to build in deploy workflow ([a519700](https://github.com/kkzakaria/netereka/commit/a519700c1c3f05df81bba9246f76b63fbd6cb29b))
* product detail page — stock, discount, variant selector & color parsing ([#43](https://github.com/kkzakaria/netereka/issues/43)) ([163a76c](https://github.com/kkzakaria/netereka/commit/163a76c1d95c5b071cabb535115ed50a06a6dbb6))
...
* remove IMAGES binding to restore image display ([#83](https://github.com/kkzakaria/netereka/issues/83)) ([7fcbf04](https://github.com/kkzakaria/netereka/commit/7fcbf04f632f06c9e1d1207898d76542da19a67d))
...
* **tests:** restore missing price in generateProductBlueprint fixtures ([#79](https://github.com/kkzakaria/netereka/issues/79)) ([3f10e7e](https://github.com/kkzakaria/netereka/commit/3f10e7e8473dbe7dbab40287857b5ff690024842))
* **uploads:** increase Server Action body size limit to 6mb ([#88](https://github.com/kkzakaria/netereka/issues/88)) ([73453c0](https://github.com/kkzakaria/netereka/commit/73453c00d186d80992d8d36467e0a6bea05baf02))
...
* add explicit fetchPriority=high on product LCP image ([31cca70](https://github.com/kkzakaria/netereka/commit/31cca70fc2aa68d60358e47a4a3232a0613115f9))
* enable ISR + edge caching on storefront ([#59](https://github.com/kkzakaria/netereka/issues/59)) ([4d6a2ce](https://github.com/kkzakaria/netereka/commit/4d6a2cee3ba93795a53b835c9f6c953069b47e8f))
* fix 6 React/Next.js performance issues (Vercel best practices) ([#75](https://github.com/kkzakaria/netereka/issues/75)) ([1d7dbd8](https://github.com/kkzakaria/netereka/commit/1d7dbd846039dcfe1dd2569facae337f5cd38dd8))
...
* inline CSS and add fetchPriority to hero LCP image ([#58](https://github.com/kkzakaria/netereka/issues/58)) ([3ca7843](https://github.com/kkzakaria/netereka/commit/3ca7843ca556f0a624106c3a66c2c2864af7b395))
...
* render product LCP image server-side for fetchpriority=high ([f720aa8](https://github.com/kkzakaria/netereka/commit/f720aa82bf2114b5b8607d5a7bfd347f40ae95d2))
* stream homepage hero before product sections for faster LCP ([48aaa26](https://github.com/kkzakaria/netereka/commit/48aaa2688dbdf20b374240051e24c0d979637bc9))
...
* add Vitest commands to CLAUDE.md ([47c0512](https://github.com/kkzakaria/netereka/commit/47c05121e84eddb82ecee32e73e0633aad631bc4))
...
* update CLAUDE.md with subcategories and RSC boundary patterns ([8263f85](https://github.com/kkzakaria/netereka/commit/8263f858c76cc54924f467d81278530d8b705f1f))
